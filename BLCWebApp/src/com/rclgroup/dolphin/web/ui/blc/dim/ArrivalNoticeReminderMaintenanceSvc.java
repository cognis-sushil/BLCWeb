...
public class ArrivalNoticeReminderMaintenanceSvc  extends RrcStandardSvc {
	public void execute(HttpServletRequest request, HttpServletResponse response, ServletContext context)
			throws Exception {
		try {
			 
			 
			String strTarget = Constants.BLC_IMPORT_EXPORT_VIEW_ARRIVAL_NOTICE_REMINDER_REMINDERMAINTENANCE_SCN;
