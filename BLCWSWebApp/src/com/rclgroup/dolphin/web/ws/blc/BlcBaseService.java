 ...
 */
public class BlcBaseService {
	
	private static final Logger logger = Logger.getLogger(BlcBaseService.class);
	...
	public final String serializeToJSONString(Object baseModel)  {
