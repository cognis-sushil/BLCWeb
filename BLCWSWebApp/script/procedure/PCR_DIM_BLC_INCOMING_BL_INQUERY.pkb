...
-----------------------------------------------------------------------------------------------------------*/
 ...
 IF ( P_I_V_SERVICE IS NOT NULL ) THEN
     ...
     V_SQL_CNDTN2 := 'AND DEX_STATUS > '||''' '''||' 
                    ...
                    DN_POT3,POD_ETD,POL_ETD,DN_CUSTOMER_POD,FOR_FSC,POD_ETA,ROWNUM  ORDER BY DISCHARGE_SERVICE, DISCHARGE_VESSEL,DISCHARGE_VOYAGE,DISCHARGE_DIRECTION,DN_CUSTOMER_POL,DN_POT1,POD_ETD,POD_ETA';  
